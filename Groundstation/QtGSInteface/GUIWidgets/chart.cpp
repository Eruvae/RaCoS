...
QMenu * Chart::contextMenu()
{
  ...
  a_data  = menu->addAction(trUtf8("Daten")); 
  a_scale = menu->addAction(trUtf8("Vertikale Skala"));
...
void Chart::paintCursorPosition(QPainter & painter)
{
  ...
  if (m_lastCurPoint==m_currentCurPoint)
  {
