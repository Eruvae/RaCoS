...
/** init timeout ms */
const uint64_t SD_INIT_TIMEOUT = 2000*MILLISECONDS;
/** erase timeout ms */
const uint64_t SD_ERASE_TIMEOUT = 10000*MILLISECONDS;
/** read timeout ms */
const uint64_t SD_READ_TIMEOUT = 300*MILLISECONDS;
/** write time out ms */
const uint64_t SD_WRITE_TIMEOUT = 600*MILLISECONDS;
//------------------------------------------------------------------------------
// SD card commands
